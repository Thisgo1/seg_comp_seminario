...
const useProducts = (itemsPerPage = 10)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchProducts = async ()=>{
            try {
                ...
                setFilteredProducts(products); // Inicialmente, lista filtrada = todos os produtos
            } catch (err) {
    ...
    // Produtos para os carrosseis (não paginados)
    ...
    // Produtos paginados (baseados na lista filtrada)
...
function ProductsPage() {
    ...
    const { products, loading, error, newProducts, bestSellingProducts, currentPage, totalPages, totalProducts, goToPage, search, searchQuery } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useProducts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProducts"])(itemsPerPage);
    // Função para atualizar a busca enquanto digita
    const handleInputChange = (e)=>{
        const value = e.target.value;
    // Atualizar o valor no input sem disparar a busca ainda
    // A busca só será disparada quando o usuário pressionar Enter ou clicar no botão
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16a47317._.js.map