...
const api = {
    // APIs externas dos providers
    providers: {
        getBrazilian: async ()=>{
            const response = await fetch(PROVIDER_URLS.brazilian);
            if (!response.ok) throw new Error("Erro ao buscar produtos brasileiros");
            return response.json();
        },
        getEuropean: async ()=>{
            const response = await fetch(PROVIDER_URLS.european);
            if (!response.ok) throw new Error("Erro ao buscar produtos europeus");
            return response.json();
        },
        getAll: async ()=>{
            try {
                ...
                const unified = [
                    ...brasilianProducts.map((p)=>({
                            ...
                            price: p.preco,
                            image: p.imagem,
                            provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProviderType"].BRASILIAN,
                            material: p.material,
                    ...
                    ...europeanProducts.map((p)=>({
                            ...
                            price: p.price,
                            image: p.gallery[0] || "",
                            provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProviderType"].EUROPEAN,
...
function ProductsPage() {
    ...
    const [bestSellingProducts, setBestSellingProducts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchProducts = async ()=>{
            try {
                setLoading(true);
                const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].products.getAll(1, 20, "user-token");
                // Se houver produtos, usa os dados da API
                if (data.items && data.items.length > 0) {
                    setProducts(data.items);
                    setShowMock(false);
                    // Simular dados para os carrosséis
                    setNewProducts(data.items.slice(0, 5)); // Primeiros 5 como novos
                    setBestSellingProducts([
                        ...data.items
                    ].sort((a, b)=>b.ratingCount - a.ratingCount).slice(0, 5)); // Top 5 mais vendidos
                } else {
                    // Se não houver produtos, usa o mock
                    setProducts(MOCK_PRODUCTS);
                    setShowMock(true);
                    // Usar mock para os carrosséis também
                    setNewProducts(MOCK_PRODUCTS.slice(0, 5));
                    setBestSellingProducts(MOCK_PRODUCTS.sort((a, b)=>b.ratingCount - a.ratingCount).slice(0, 5));
                }
            } catch (error) {
    ...
    const handleSearch = async ()=>{
        ...
        try {
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].products.search(searchQuery, "user-token");
            setProducts(data);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b982a4e7._.js.map