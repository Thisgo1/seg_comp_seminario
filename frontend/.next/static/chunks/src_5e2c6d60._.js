...
const useProductDetails = (provider, productId)=>{
    ...
    const fetchData = async ()=>{
        try {
            ...
            // Buscar produtos relacionados (filtro por categoria)
            ...
            // Buscar avaliações (simulado - em produção seria uma chamada API real)
...
function ProductDetailsPage({ params }) {
    ...
    const { product, relatedProducts, ratings, loading, error, isMock } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useProductDetails$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductDetails"])(params.provider, params.id);
    const handleAddToCart = ()=>{
        ...
        // Feedback visual (pode substituir por toast)
...
_s(ProductDetailsPage, "G+djoTo4MPyC/d+PAsnOhApPb+4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
...
//# sourceMappingURL=src_5e2c6d60._.js.map