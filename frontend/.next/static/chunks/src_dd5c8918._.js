...
_s(Header, "vYemAIKUbNPFZ9U/xg1Pc5Meku0=", false, function() {
    return [
            ...
            const fetchData = {
                "ProductDetailsPage.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        // Busca avaliações
                        const ratingsData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].ratings.getProductRatings(params.id, provider);
...
_s(ProductDetailsPage, "LY/D3JTDByXw5fS94xpdNZEL6AQ=");
...
//# sourceMappingURL=src_dd5c8918._.js.map