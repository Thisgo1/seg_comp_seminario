...
function Login() {
    ...
    async function onSubmit(values) {
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].auth.signin({
                email: values.email,
                password: values.password
            });
            // Supondo que a API retorne um token
            if (response.accessToken) {
                // Armazenar o token (em localStorage, cookies ou contexto)
...
_s(Login, "uuUaD64L/oc7wX1pO2P1xKqAtkc=", false, function() {
    return [
...
//# sourceMappingURL=src_bc637152._.js.map