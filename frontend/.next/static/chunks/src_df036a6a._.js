...
const useProductDetails = (provider, id)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useProductDetails.useEffect": ()=>{
            const fetchData = {
                "useProductDetails.useEffect.fetchData": async ()=>{
                    try {
                        setLoading(true);
                        // 1. Buscar detalhes do produto
                        const [allProducts] = await Promise.all([
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].providers.getAll().catch({
                                "useProductDetails.useEffect.fetchData": ()=>[]
                            }["useProductDetails.useEffect.fetchData"])
                        ]);
                        const foundProduct = allProducts.find({
                            "useProductDetails.useEffect.fetchData.foundProduct": (p)=>p.id === id && p.provider === provider
                        }["useProductDetails.useEffect.fetchData.foundProduct"]);
                        if (!foundProduct) {
                            setIsMock(true);
                            ...
                            setRelatedProducts(allProducts.filter({
                                "useProductDetails.useEffect.fetchData": (p)=>p.id !== id
                            }["useProductDetails.useEffect.fetchData"]).slice(0, 4).map({
                                "useProductDetails.useEffect.fetchData": (p)=>({
                                        ...p,
                            ...
                            setRelatedProducts(allProducts.filter({
                                "useProductDetails.useEffect.fetchData": (p)=>p.id !== id && p.category === foundProduct.category
                            }["useProductDetails.useEffect.fetchData"]).slice(0, 4));
                        }
                    } catch (err) {
...
//# sourceMappingURL=src_df036a6a._.js.map