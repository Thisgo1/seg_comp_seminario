...
"[project]/src/app/prod/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ProductDetailsPage({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDetailsPage.useEffect": ()=>{
            const fetchData = {
                "ProductDetailsPage.useEffect.fetchData": async ()=>{
                    try {
                        setLoading(true);
                        setIsMock(false);
                        const provider = "BRASILIAN";
                        // Busca os dados do produto
                        const productData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].products.getById(provider, params.id, "user-token");
                        setProduct(productData);
                        // Busca as avaliações do produto
                        const ratingsData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].ratings.getProductRatings(params.id, provider, 1, 10, "user-token");
                        setRatings(ratingsData);
                        // Busca produtos para o carrossel
                        const productsData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].products.getAll(1, 20, "user-token");
            ...
            }["ProductDetailsPage.useEffect.fetchData"];
            fetchData();
        }
    }["ProductDetailsPage.useEffect"], [
        params.id
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    isMock && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(ProductDetailsPage, "281pHzVzaFWrSabe82C3VNHzsNI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useCart$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
    ];
});
...
//# sourceMappingURL=src_59fb1b8d._.js.map