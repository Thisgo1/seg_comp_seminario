            ...
            try {
                ...
                const unified = [
                    ...brasilianProducts.map((p)=>({
                            ...
                            price: p.preco,
                            image: p.imagem,
                            provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProviderType"].BRASILIAN,
                            material: p.material,
                    ...
                    ...europeanProducts.map((p)=>({
                            ...
                            price: p.price,
                            image: p.gallery[0] || "",
                            provider: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ProviderType"].EUROPEAN,
...
function ProductsPage() {
        ...
        "ProductsPage.useEffect": ()=>{
            const fetchProducts = {
                "ProductsPage.useEffect.fetchProducts": async ()=>{
                    try {
                        setLoading(true);
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].products.getAll(1, 20, "user-token");
                        ...
                        if (data.items && data.items.length > 0) {
                            ...
                            setBestSellingProducts([
                                ...
                                "ProductsPage.useEffect.fetchProducts": (a, b)=>b.ratingCount - a.ratingCount
                            }["ProductsPage.useEffect.fetchProducts"]).slice(0, 5)); // Top 5 mais vendidos
                        } else {
                            ...
                            setBestSellingProducts(MOCK_PRODUCTS.sort({
                                "ProductsPage.useEffect.fetchProducts": (a, b)=>b.ratingCount - a.ratingCount
                            }["ProductsPage.useEffect.fetchProducts"]).slice(0, 5));
                        }
                    } catch (error) {
    ...
    const handleSearch = async ()=>{
        ...
        try {
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].products.search(searchQuery, "user-token");
            setProducts(data);
...
_s(ProductsPage, "pPsGBRGqO0uKbTIjK+Q+3+5fDzQ=");
_c = ProductsPage;
var _c;
...
//# sourceMappingURL=src_704a2293._.js.map